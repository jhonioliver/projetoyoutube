...
export default function VSLBlackKim() {
  useEffect(() => {
    const loadPlayerScript = () => {
      ...
      script.src =
        "https://scripts.converteai.net/1c3bcfc5-8544-4f0a-9e4c-0927e07f2e22/players/691e6c43d55a0071a20f4ce0/v4/player.js";
      script.async = true;
    ...
    return () => {
      const existingScript = document.querySelector(
        'script[src*="691e6c43d55a0071a20f4ce0"]'
      );
  ...
  return (
    // @ts-expect-error - player é carregado via script externo
    <vturb-smartplayer
